...
namespace Image_Processor.Data.Services.Account
{
    public class AccountService : IAccountService
    {
        ...
        public async Task<Response> CreateAsync(SignUpViewModel signUpViewModel)
        {
            ...
            try
            {
                var user = new ApplicationUser { Email = signUpViewModel.Email, UserName = signUpViewModel.Email, FirstName = signUpViewModel.FirstName, LastName = signUpViewModel.LastName };
                response.Object = await _accountRepository.CreateAsync(user, signUpViewModel.Password);
